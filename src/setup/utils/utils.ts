...
export function alphabeticallyOther(tag: string, ascending: any) {
  return function (a: any, b: any) {
    let avalue = a.MainDicomTags[tag].Value;
    let bvalue = b.MainDicomTags[tag].Value;
...
export function alphabeticallyPatient(tag: string, ascending: any) {
  return function (a: any, b: any) {
    let avalue = a.MainDicomTags[tag];
    let bvalue = b.MainDicomTags[tag];
