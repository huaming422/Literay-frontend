...
const DeviceConfigPage = () => {
  ...
  const columnValues: any = useSelector<RootState>(({ patients }) => patients.patientColumnValues, shallowEqual) as any;
  const seriesColumnValues: any = useSelector<RootState>(({ patients }) => patients.seriesColumnValues, shallowEqual) as any;
